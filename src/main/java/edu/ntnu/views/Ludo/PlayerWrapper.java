...
/**
 * The PlayerWrapper class acts as a bridge between the logical representation of a Player and its
 * visual components in the Ludo game.
 */
public class PlayerWrapper {
   ...
   *
   * @return the players assigned color
   */
